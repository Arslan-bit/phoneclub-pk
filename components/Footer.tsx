...
const SOCIAL = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/phoneclub_pk",
    icon: (
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/@phoneclub_official",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@phone_club_pk",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/share/1EEEYgwEB7/?mibextid=wwXIfr",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
...
export default function Footer() {
  return (
    <footer className="bg-[#080808] border-t border-yellow-600/20 mt-20">
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div className="flex gap-3">
              {SOCIAL.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center text-gray-500 hover:text-yellow-400 hover:bg-yellow-400/10 transition-all"
                >
                  {s.icon}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["iPhone Cases", "Screen Guards", "Chargers", "Cables", "Earphones", "Power Banks"].map((item) => (
                <li key={item}>
                  <Link href="/products" className="text-gray-500 hover:text-yellow-400 text-sm transition-colors">
                    {item}
                  </Link>
                </li>
              ))}
            ...
            <ul className="space-y-3">
              {SOCIAL.map((s) => (
                <li key={s.label}>
                  ...
                  >
                    <span className="text-yellow-600 group-hover:text-yellow-400 transition-colors">
                      {s.icon}
                    </span>
                    {s.label}
                  </a>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2 text-gray-500 text-sm">
                ...
                <a
                  href="mailto:phoneclubofficial.pk@gmail.com"
                  className="hover:text-yellow-400 transition-colors break-all"
                >
                  phoneclubofficial.pk@gmail.com
                </a>
              </li>
        ...
        <div className="mt-12 pt-6 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-xs">© 2025 PhoneClub.pk — All rights reserved</p>
